<template>
    <div class="news_container">
        <div class="news_header">
            <span class="news_title">人才招聘</span>
        </div>
        <div class="newsList">
            <div class="news_item" v-for="item in newsList" :key="item['id']" @click="toDetail(2, item['id'])">
                <img style="width:260px;height:150px;" :src="covertHttp(item['img'])" />
                <div class="text_content">
                    <div>
                        <div class="title">{{ item['title'] }}</div>
                        <div class="description">{{ item['description'] }}{{ item['description'] }}{{ item['description'] }}
                        </div>
                    </div>
