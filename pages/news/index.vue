<template>
    <div class="news_container">
        ...
        <div class="newsList">
            <div class="news_item" v-for="item in newsList" :key="item['id']" @click="toDetail(1,item['id'])">
                <img style="width:260px;height:150px;" :src="covertHttp(item['img'])" />
                <div class="text_content">
                    <div>
                        <div class="title">{{ item['title'] }}</div>
                        <div class="description">{{ item['description'] }}{{ item['description'] }}{{ item['description'] }}</div>
                    </div>
...
useHead({
    title: '新闻中心 | 广州库平信息技术有限公司',
    meta: [
        { name: 'description', content: '新闻中心' },
        { name: 'keywords', content: '新闻中心' }
    ]
})
// 图片拼接
